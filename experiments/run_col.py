from col.train import run_task
...
def main():
    ...
    # Experiment
    parser.add_argument('--name', default='COL_ROPE', type=str)
    parser.add_argument('--env_name', default='RopeFlatten')
    parser.add_argument('--log_dir', default='./data/col_ropeflatten/')
    ...
    parser.add_argument('--num_pretrain_steps', default=30_000, type=int, help='Number of pre-training steps')
    parser.add_argument('--num_data_collections', default=1, type=int, help='Number of pre-training steps')
